# Claude Task: Repository Bootstrap

## Goal

Create the backend, frontend, Docker environment, CI pipeline, OpenAPI setup, Storybook, code-quality tooling, and test harness.
