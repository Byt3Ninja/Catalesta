# Claude Task: Mock Startup Gate OIDC

## Goal

Implement discovery, JWKS, authorization code flow, PKCE, token issuance, revocation, logout, seeded users, profile APIs, consent APIs, and achievement APIs.
