# Claude Task: Service Requests and Marketplace

## Goal

Implement startup service requests, provider matching, quotations, approvals, delivery tracking, evidence, acceptance, rating, and closure.
