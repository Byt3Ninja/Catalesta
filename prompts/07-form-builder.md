# Claude Task: Form Builder

## Goal

Implement schema-driven forms, field types, repeaters, tables, calculated fields, conditional logic, translations, and profile mapping.
