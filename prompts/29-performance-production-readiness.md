# Claude Task: Performance and Production Readiness

## Goal

Implement load tests, query optimization, backup restore tests, disaster recovery, rollback, migration rehearsal, UAT, and launch checklist.
