# Claude Task: Identity, Profiles, and Consent

## Goal

Implement OIDC client integration, subject mapping, local projections, role profiles, consent, snapshots, update proposals, and achievement publishing.
