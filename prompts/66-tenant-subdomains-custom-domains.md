# Claude Task: Tenant Subdomains and Custom Domains

## Goal

Implement unique platform subdomains, custom-domain registration, DNS verification, host routing, automatic TLS lifecycle, health checks, safe removal, and domain audit.
