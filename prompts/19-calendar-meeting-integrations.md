# Claude Task: Calendar and Meeting Integrations

## Goal

Implement provider interfaces and mock adapters for Google, Microsoft, Jitsi, Zoom, and Teams with retries and webhooks.
