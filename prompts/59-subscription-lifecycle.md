# Claude Task: Subscription Lifecycle

## Goal

Implement trial, active, past-due, grace, restricted, suspended, cancelled, expired, renewal, retention, and enterprise contract states.
