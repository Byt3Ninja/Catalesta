# Claude Task: Tenant Basic Branding

## Goal

Implement safe tenant branding for logos, favicon, portal name, colors, footer, support contact, public pages, emails, and certificates with previews and accessibility validation.
