# Claude Task: Version Migration Management

## Goal

Implement controlled migration between form, workflow, assessment, stage, and program-template versions with impact preview, rollback, audit, and safety validation.
