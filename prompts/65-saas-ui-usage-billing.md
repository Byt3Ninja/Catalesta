# Claude Task: SaaS Billing and Usage UX

## Goal

Implement plan comparison, usage dashboard, invoices, payment status, upgrade, downgrade, add-ons, limits, billing contacts, and role-based billing access.
