# Claude Task: Real Startup Gate Cutover

## Goal

Replace mocks with Startup Gate sandbox and production adapters, run contract tests, reconcile identities, migrate consent references, and execute cutover.
