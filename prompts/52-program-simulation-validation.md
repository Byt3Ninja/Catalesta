# Claude Task: Program Simulation and Validation

## Goal

Implement publish-time dependency validation and non-destructive simulation for eligibility, stage routing, scoring, workflow behavior, notifications, and graduation rules.
