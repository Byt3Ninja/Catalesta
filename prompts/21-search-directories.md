# Claude Task: Search and Directories

## Goal

Implement startup, founder, mentor, service-provider, and program directories with visibility, filtering, pagination, sorting, and search abstractions.
