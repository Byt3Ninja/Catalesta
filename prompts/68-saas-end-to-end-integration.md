# Claude Task: SaaS End-to-End Integration

## Goal

Validate signup, trial, Geidea checkout, subscription activation, entitlement enforcement, usage metering, custom domain setup, branding publication, recurring payment, failed-payment handling, upgrade, downgrade, cancellation, and tenant isolation.
