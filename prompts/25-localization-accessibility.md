# Claude Task: Localization and Accessibility

## Goal

Implement Arabic and English, RTL/LTR, translations, time zones, date and number formats, keyboard navigation, screen-reader support, and WCAG tests.
