# Claude Task: SaaS Security Testing

## Goal

Implement entitlement-bypass tests, payment isolation, Geidea webhook replay and signature tests, usage integrity, billing authorization, and dunning-state tests.
