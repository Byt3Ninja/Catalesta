# Claude Task: Observability and Operations

## Goal

Implement structured logs, metrics, tracing, health checks, readiness checks, queue monitoring, failed-job tools, alerts, dashboards, and runbooks.
