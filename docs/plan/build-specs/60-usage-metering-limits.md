# Claude Task: Usage Metering and Limits

## Goal

Implement usage events, counters, periods, thresholds, soft and hard enforcement, adjustments, reconciliation, and audit.
