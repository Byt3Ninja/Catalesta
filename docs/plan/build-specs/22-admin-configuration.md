# Claude Task: Administration and Configuration

## Goal

Implement platform and organization settings, branding, taxonomies, skills, sectors, categories, feature flags, templates, and history.
