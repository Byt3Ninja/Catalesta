# Claude Task: Audit and Compliance

## Goal

Implement immutable audit records, sensitive-access logs, consent history, export logs, retention, investigation screens, and compliance reporting.
