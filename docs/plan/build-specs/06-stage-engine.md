# Claude Task: Stage Engine

## Goal

Implement stage definitions, versions, ordering, dependencies, parallel stages, conditional routing, entry and exit rules, and participant state.
