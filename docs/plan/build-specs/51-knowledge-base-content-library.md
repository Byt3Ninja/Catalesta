# Claude Task: Knowledge Base and Content Library

## Goal

Implement guides, templates, policies, recordings, resources, FAQs, versioning, role-based access, assignment, search, and download tracking.
