...
final class Cohort extends Model
{
    ...
    protected $fillable = ['program_id', 'form_version_id', 'stage_pipeline_version_id', 'name', 'slug', 'status', 'enrollment_opens_at', 'enrollment_closes_at', 'starts_at', 'ends_at', 'capacity', 'timeline'];
